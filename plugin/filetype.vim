...
augroup filetypedetect
  autocmd!
  autocmd BufNewFile,BufRead *.agda set filetype=agda | set syntax=agda
  autocmd BufNewFile,BufRead *.asm,*.s set filetype=asm | set syntax=asm
  autocmd BufNewFile,BufRead *.bashrc set syntax=zsh
  ...
  autocmd BufNewFile,BufRead *.kind, set filetype=kind | set syntax=kind
